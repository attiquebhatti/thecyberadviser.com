    ...
    >
      ...
      <div className="relative p-8 md:p-9">
        <div className="flex items-center gap-3 mb-5">
          <span className="px-3 py-1.5 text-xs font-semibold text-amber-500 bg-amber-500/10 rounded-lg border border-amber-500/10">
            {article.category}
          </span>
          <span className="text-xs text-slate-500">{article.readTime}</span>
        </div>

        <h3 className="text-xl font-semibold text-white mb-4 group-hover:text-amber-500 transition-colors duration-300 line-clamp-2">
          {article.title}
        </h3>
        ...
        <div className="flex items-center gap-2 text-sm font-medium text-slate-500 group-hover:text-amber-500 transition-colors duration-300">
