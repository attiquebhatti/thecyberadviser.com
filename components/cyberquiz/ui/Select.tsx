  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        id={id}
        className={cn(
          'w-full px-3 py-2 rounded-lg bg-[#1a1a2e] border border-[#2d2d44] text-[#f1f5f9] focus:outline-none focus:border-[#6bd348] focus:ring-1 focus:ring-[#6bd348] transition-colors cursor-pointer',
          error && 'border-[#ef4444]',
          className
        )}
        {...props}
