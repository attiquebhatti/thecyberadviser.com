...
export const CQButton = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, children, disabled, ...props }, ref) => {
    const base = 'inline-flex items-center justify-center gap-2 rounded-lg font-semibold transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#10b981] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer';
    const variants = {
      primary:   'bg-[#10b981] hover:bg-[#059669] text-[#04130c] focus:ring-offset-[#0f0f1a]',
      ...
      outline:   'bg-transparent border-2 border-[#10b981] text-[#10b981] hover:bg-[#10b981]/10 focus:ring-offset-[#0f0f1a]',
    };
