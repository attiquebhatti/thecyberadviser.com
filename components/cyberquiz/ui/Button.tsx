...
export const CQButton = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, children, disabled, ...props }, ref) => {
    const base = 'inline-flex items-center justify-center gap-2 rounded-lg font-semibold transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6bd348] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer';
    const variants = {
      primary:   'bg-[#6bd348] hover:bg-[#5cbf3c] text-[#04130c] focus:ring-offset-[#0f0f1a]',
      ...
      outline:   'bg-transparent border-2 border-[#6bd348] text-[#6bd348] hover:bg-[#6bd348]/10 focus:ring-offset-[#0f0f1a]',
    };
