...
const TIER_COLOR: Record<string, string> = {
  free: '#94a3b8', educator: '#06b6d4', pro: '#6bd348', enterprise: '#FFC300',
};
    ...
    <div className="min-h-screen bg-[#0f0f1a]">
      <header className="bg-[#1a1a2e] border-b border-[#2d2d44] px-4 py-4">
        <div className="max-w-7xl mx-auto flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[#f1f5f9] flex items-center gap-2"><Users className="w-5 h-5 text-[#6bd348]" /> Global Admin · Users</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        {summary && (
          <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <StatCard icon={Users} label="Total Users" value={summary.total} color="#6bd348" />
        ...
        <div className="relative max-w-sm">
          ...
          <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search by name or email…"
            className="w-full rounded-lg bg-[#1a1a2e] border border-[#2d2d44] pl-9 pr-4 py-2.5 text-sm text-[#f1f5f9] placeholder:text-[#64748b] focus:outline-none focus:border-[#6bd348]/60" />
        </div>
                  ...
                  <tr key={u.id} className="border-t border-[#2d2d44] hover:bg-white/[0.02]">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#6bd348] to-[#a855f7] flex items-center justify-center text-xs font-bold text-white shrink-0">
                    ...
                    <td className="px-4 py-3">
                      {u.isSuperAdmin ? (
                        ...
                        <select
                          ...
                          className="rounded-lg bg-[#0f0f1a] border border-[#2d2d44] px-2 py-1 text-xs text-[#f1f5f9] focus:outline-none focus:border-[#6bd348]/60 cursor-pointer"
                        >
