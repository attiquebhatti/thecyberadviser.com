...
const TIERS = [
  ...
  { id: 'educator', label: 'Educator', price: '$8/mo',  color: '#7c3aed', features: ['500 players', 'Unlimited quizzes', 'All 8 modes', 'Unlimited AI'] },
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-lg bg-[#0f0f1a] border border-[#2d2d44] text-[#f1f5f9] placeholder:text-[#4a4a6a] focus:outline-none focus:border-[#7c3aed] transition-colors text-sm"
              />
            </div>
            <div>
          ...
          <form onSubmit={handleChangePassword} className="space-y-3">
            <div className="relative">
              <input
                ...
                required
                className="w-full px-3 pr-10 py-2.5 rounded-lg bg-[#0f0f1a] border border-[#2d2d44] text-[#f1f5f9] placeholder:text-[#4a4a6a] focus:outline-none focus:border-[#7c3aed] transition-colors text-sm"
              />
        ...
        <div className="rounded-xl bg-[#1a1a2e] border border-[#2d2d44] p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {TIERS.map(tier => (
              <div key={tier.id} className={`p-4 rounded-xl border-2 transition-all ${user.tier === tier.id ? 'border-[#7c3aed] bg-[#7c3aed]/10' : 'border-[#2d2d44]'}`}>
                ...
                {user.tier === tier.id
                  ? <p className="text-xs text-[#7c3aed] mt-2 text-center font-medium">Current plan</p>
