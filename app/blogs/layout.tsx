...
export const metadata: Metadata = {
  ...
  description:
    'Practical articles on Cortex XDR/XSIAM, Prisma SASE, Strata NGFW, Zero Trust, identity security (ITDR), and SOC automation — written for enterprise security teams.',
